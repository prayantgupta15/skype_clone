...
class CallMethods {
  ...
  Future<bool> makeCall({Call call}) async {
    try {
      print("4. trying making call");
      call.hasDialled = true;
      Map<String, dynamic> hasDialledMap = call.toMap(call);
      call.hasDialled = false;
      Map<String, dynamic> hasNotDialledMap = call.toMap(call);

      callCollection.document(call.callerId).setData(hasDialledMap);

      callCollection.document(call.receiverId).setData(hasNotDialledMap);
      return true;
    } catch (e) {
      print(e);
      return false;
  ...
  Future<bool> endCall({Call call}) async {
    try {
      print("in call_methods.endcall()" + call.callerId);
